...
//        System.out.println(fullReceipt);
        ...
        //**************************************************************
        // test code for wrapper methods
        //**************************************************************
        String strChar = "01234567890123456789012345678901234567890123456789012"; // 53 chars : index 0 to 62

        String strWord = "012 456789012345 78901 345678901234567890123456789 12"; // 53 chars : index 0 to 62

        //*****************************************************************
        // PART 4 : wrap at 50 characters, even if in the middle of a word
        //*****************************************************************
        String testOutHard = wrapOutput(strChar, 50);
        System.out.println("test output Hard Wrap:");
        System.out.println(testOutHard);
...
//        System.out.println(hardWrappedReceipt);
        ...
        //****************************************************************
        String testOutWord = wrapOutputWordWise(strWord, 50);
        System.out.println("test output Word Wrap:");
        System.out.println(testOutWord);
...
//        System.out.println(wordWrappedReceipt);
    ...
    private static String wrapOutputWordWise(String str, int wrapLength) {
        ...
        while(inputLineLength - offset > wrapLength) {
            ...
            int spaceToWrapAt = str.lastIndexOf(' ', (wrapLength + offset));
                ...
                // INDEX vs LENGTH note on lastIndexOf parameter.
                // we thought this should be ((wrapLength + offset) - 1)
                // because it looked like the parameter to lastIndexOf was an *index*
                // however, I tested it out down to the character level, and NOT SUBTRACTING 1 works correctly,
                // if we subtract 1 it wraps the word too soon (if the word includes a 50th char at index 49 it wraps)

            // I think the real point is that we're EATING A SPACE on the turn, if 51st one (index 50) is a space,
            // that space is not kept onto the next line.
    ...
    private static String wrapOutput(String str, int wrapLength) {
        ...
        while (inputLineLength - offset > wrapLength) {
            ...
            // and extends to (endIndex - 1) :: e.g. the end parameter can be a LENGTH b/c it is translated to INDEX.
